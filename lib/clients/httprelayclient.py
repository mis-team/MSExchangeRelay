...
class HTTPRelayClient(ProtocolClient):
    ...
    def __init__(self, serverConfig, target, targetPort = 80, extendedSecurity=True, body=None ):
...
class HTTPSRelayClient(HTTPRelayClient):
    ...
    def __init__(self, serverConfig, target, targetPort = 443, extendedSecurity=True, body=None ):
        HTTPRelayClient.__init__(self, serverConfig, target, targetPort, extendedSecurity, body)
